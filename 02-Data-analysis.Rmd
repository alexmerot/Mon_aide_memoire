...
downloadthis::download_file(
  path = "examples/faune-RNN-jura/Faune-vertebres-PG3.pdf",
  output_name = "Faune-vertebres-PG3",
  button_label = "Télécharger le PDF",
  button_type = "warning",
  has_icon = TRUE,
  icon = "fa fa-save",
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
classification_oiseaux <- readr::read_csv("examples/webscraping/classification_avifaune.csv")
```
