...
\StringTok{  }\KeywordTok{stat\_sf\_coordinates}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ data\_rnn, }\DataTypeTok{colour =} \StringTok{"darkred"}\NormalTok{, }\DataTypeTok{size =} \FloatTok{1.5}\NormalTok{) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{annotation\_map\_tile}\NormalTok{(}\DataTypeTok{zoomin =} \DecValTok{{-}1}\NormalTok{, }\DataTypeTok{type =} \StringTok{"stamenwatercolor"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_sf}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ crop\_regions, }\DataTypeTok{colour =} \StringTok{"black"}\NormalTok{, }\DataTypeTok{fill =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{size =} \FloatTok{1.1}\NormalTok{) }\OperatorTok{+}
...
{\centering \includegraphics[width=1\linewidth]{Mon_aide_memoire_R_files/figure-latex/plot-rnn-1} \includegraphics[width=1\linewidth]{Mon_aide_memoire_R_files/figure-latex/plot-rnn-2} 

}

\caption{(A) Carte des Réserves Naturelles de la France métropolitaine. (B) Carte montrant la délimitation de la Réserve Naturelle Nationale de la Haute Chaîne du Jura.}\label{fig:plot-rnn}
\end{figure}
...
##  ggspatial   * 1.1.3.9000 2020-08-10 [1] Github (paleolimbot/ggspatial@4a965f1)
