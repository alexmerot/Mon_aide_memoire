...
package \textbf{blogdown} (\url{https://bookdown.org/yihui/blogdown/}).
...
globalement le framework utilisé pour faire plus facilement des documents
...
cette adresse : \url{https://geocompr.robinlovelace.net/} --- si vous préférez le
...
un \emph{objet} tandis que le raster est une \emph{image}. Ainsi, les vecteurs sont
