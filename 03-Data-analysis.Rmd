...
<figure>
  <iframe title="Données de recensement des vertébrés dans la Réserve Naturelle Nationale de la Haute Chaîne du Jura." src="examples/faune-RNN-jura/Faune-vertebres-PG3.pdf" width="100%" height="500px"></iframe>
  <figcaption>(#fig:jura-data-pdf) Figure \@ref(fig:jura-data-pdf): Données de recensement des vertébrés dans la Réserve Naturelle Nationale de la Haute Chaîne du Jura.</figcaption>
</figure>
