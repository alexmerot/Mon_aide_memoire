...
(ref:plot-rnn) (A) Carte des Réserves Naturelles de la France métropolitaine. (B) Carte montrant la délimitation de la Réserve Naturelle Nationale de la Haute Chaîne du Jura.
...
rnn_france <- ggplot() +
  ...
  stat_sf_coordinates(data = data_rnn, colour = "darkred", size = 1.5) +
