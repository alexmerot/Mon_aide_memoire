...
Pour stocker la géométrie de ces **entités géographiques**, l'OGC [^OGC] (*Open
Geospatial Consortium*) a développé un modèle standardisé pour les Bases de
Données Spatiales (BDS). Ce modèle s'appelle **Modèle d'Entité Simple** (SFS
pour *Simple Feature for SQL* en anglais) et permet définir des fonctions pour
