...
description_rnn <- data_rnn %>%
  ...
  mutate(
    description = glue(
      '
      <style>
      div.leaflet-popup-content {{width:auto !important; height:auto !important}}
      </style>
...
if (!file.exists("docs/images/plot-mapview.html")) {
  st_point_on_surface(data_rnn) %>%
    ...
    mapshot(
      here::here("images", "plot-mapview.html"), 
...
# file.copy(from = "images/plot-mapview_files", to = "docs/images", recursive = TRUE)
