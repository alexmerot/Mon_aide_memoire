...
Ce livre est mis à jour régulièrement et est mis à disposition gratuitement à
cette adresse : <https://geocompr.robinlovelace.net/> --- si vous préférez le
format papier et/ou voulez soutenir les auteurs, il est bien sûr disponible à
l'achat.
...
un *objet* tandis que le raster est une *image*. Ainsi, les vecteurs sont
constitués de points, de lignes et de polygones créés à partir de formules
mathématiques, tandis que les rasters sont des grilles constituées en cellules
...
deviennent floues (elles « pixelisent »).
...
résolution est de 10 m. La résolution spatiale permet donc de définir le niveau
de détail du jeu de données. La netteté de l'image est ainsi dépendant de la
résolution spatiale puisqu'il y aura plus de détails capturés avec des cellules de petite taille (résolution élevée ou fine) qu'avec des cellules de grande taille (résolution basse ou grossière).
