...
```{r plot-rnn-jura-interactive, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="(ref:plot-rnn-jura-interactive)"}
girafe(
...
Carte interactive montrant la localisation des Réserves Naturelles Nationales en France métropolitaine. La taille des points est proportionnelle à la superficie des réserves. Une courte description est visible en cliquant sur les points.

```{r, out.width="100%", fig.cap="test", warning=FALSE}
